...
public interface TN5250jConstants {
    ...
    /** User-home subdirectory for emulator settings and keystores. */
    String TN5250J_FOLDER = ".tn5250j";

    String EXTERNAL_PROGRAM_REGISTRY_KEY = "etnPgmProps";
    String EXTERNAL_PROGRAM_PROPERTIES_FILE_NAME = "tn5250jExternalProgram.properties";
    String EXTERNAL_PROGRAM_HEADER = "External Program Settings";
