...
public class ExternalProgramConfig {
    ...
    public static final String EXTERNAL_PROGRAM_REGISTRY_KEY =
            TN5250jConstants.EXTERNAL_PROGRAM_REGISTRY_KEY;
    public static final String EXTERNAL_PROGRAM_PROPERTIES_FILE_NAME =
            TN5250jConstants.EXTERNAL_PROGRAM_PROPERTIES_FILE_NAME;
    public static final String EXTERNAL_PROGRAM_HEADER =
            TN5250jConstants.EXTERNAL_PROGRAM_HEADER;
